...
def apply_shadow_mask(pred, gt, pred_file, shadow_mask_dir):
    ...
    shadow_path = os.path.join(shadow_mask_dir, f"cleaned_{base_name}_5.png")
...
def apply_labeling_mask(pred, gt, pred_file, labeling_type, labeling_path):
    ...
    labeling_mask = np.invert(labeling_mask)  # Invert mask
...
def process_single_pair(args):
    ...
    try:
        # Process depth - Now properly handle the 3 return values
